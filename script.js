  ...
  function success(position) {
    ...
    console.log(today);
        ...
        $('.preview').on('click', function(e) {
          ...
          $.ajax({
          url:'https://api.aerisapi.com/sunmoon/moonphases/?p=' + latitude + ',' + longitude + '&to=:' + today + '&client_id=id5zV9deaqOeGuK3mYadq&client_secret=Yfvc6cceJpNkt5aqmJB5i30VV1WfmS6z75d3hWRy',
          today: today,
          latitude: latitude,
          longitude: longitude
          }).done(function(data) {
